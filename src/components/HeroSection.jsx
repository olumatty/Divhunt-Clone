            ...
            <div className="flex max-w-[1130px] w-full flex-col gap-y-[80px] md:gap-y-[100px] lg:gap-y-[120px]">
              <div id="builder" className="">
                ...
                <div className="Card-animation">
                  <div className="flex bg-[#242424] gap-y-[40px] md:gap-y-[60px] lg:gap-y-0 p-[20px] lg:p-[30px] rounded-[20px] lg:flex-row lg:gap-x-[70px] md:flex-col-reverse">
                      ...
                      <div className="">
                        ...
                        <div className="grid gap-x-[30px] mt-[60px] grid-cols-2">
                          ...
                          <div>
                            ...
                            <p className="text-[#9e9e9e] text-[12px]">
                            Develop and collaborate with your team in real-time - all on one page.
                            </p>
                          </div>
                          ...
                          <div>
                            ...
                            <p className="text-[#9e9e9e] text-[12px]">
                            Design with full control over responsive breakpoints.
                            </p>
                          </div>

                          <div>
                            <div className="flex gap-y-[15px] md:mt-[30px] items-start mb-[10px] flex-col">
                              <img
                                src={Customcss}
                                alt="icon"
                                className="max-w-full"
                            ...
                            Advance styling with custom CSS, in-builder editing, & state targeting.
                            </p>
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="overflow-hidden relative pt-[30px] pr-[30px] bg-cover bg-no-repeat rounded-[10px] md:rounded-[20px]" style={{ backgroundImage: `url(${Greenbg})` }}>
                        <img src ={Builder} alt="image" className="rounded-tr-[10px] w-full max-w-full"/>

                        <div className='top[-1%] left-[1%] right-[-1%] bottom-[-1%] flex opacity-0 gap-y-[5px] absolute bg-[rgba(7, 7, 9, 0.1)] transition-all duration-400
