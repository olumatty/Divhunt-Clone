    ...
    <div className="pt-[60px] pb-[140px] block isolate">
      <div className="w-[100%] max-w-[1400px] mt-0 mx-auto px-[20px]">
        <div className="mb-[100px]">
          <div className="flex flex-col md:flex-row items-center mb-[40px]  justify-between">
          ...
          <div className="grid gap-[20px] grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
            <div>
              <div className="cursor-pointer transition-all duration-200 ease-linear text-white group">
                ...
                <div>
                  ...
                  <p className="text-[#9e9e9e] font-[500] whitespace-break-spaces">
                    Divhunt
                  </p>
                </div>
              </div>
          ...
          <div className="grid gap-[20px] grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
            <div>
              <div className="h-[100%] flex flex-col bg-[rgba(36,36,36,0.6)] transition-all duration-300 ease-in-out p-[20px] rounded-[24px] relative cursor-pointer">
                <p className="top-[20px] left-auto right-[20px] bottom-auto absolute text-[#9e9e9e]">
                  Free
                </p>
                <img
                  src={Typed}
                ...
                <p className="mb-[30px] text-[#9e9e9e]">
                  Typed.js is a library that types. Enter in any string, and
                  watch it type at the speed you've set, backspace what it's
                  typed, and begin a new sentence for however many strings
                  you've set.
                </p>
                <p className="mt-auto text-[#9e9e9e] text-[14px] whitespace-break-spaces    ">
                  Divhunt
                </p>
              </div>
            </div>
            ...
            <div>
              <div className="h-[100%] flex flex-col bg-[rgba(36,36,36,0.6)] transition-all duration-300 ease-in-out p-[20px] rounded-[24px] relative cursor-pointer">
                ...
                <p className="mb-[30px]  text-[#9e9e9e]">
                  Easily paginate your website's content. Perfect for both
                  CMS-based and static elements
                </p>
                <p className="mt-auto text-[#9e9e9e] text-[14px] whitespace-break-spaces    ">
                  Divhunt
                </p>
            ...
            <div>
              <div className="h-[100%] flex flex-col bg-[rgba(36,36,36,0.6)] transition-all duration-300 ease-in-out p-[20px] rounded-[24px] relative cursor-pointer">
                ...
                <p className="mb-[30px] text-[14px] text-[#9e9e9e]">
                  Easily add a smooth scroll-to-top button for quick navigation.
                </p>
                <p className="mt-auto text-[#9e9e9e] text-[14px] whitespace-break-spaces    ">
                  Divhunt
                </p>
            ...
            <div>
              <div className="h-[100%] flex flex-col bg-[rgba(36,36,36,0.6)] transition-all duration-300 ease-in-out p-[20px] rounded-[24px] relative cursor-pointer">
                ...
                <p className="mb-[30px] text-[14px] text-[#9e9e9e]">
                  Easily embed a Vimeo video and customize it with a
                  user-friendly interface, including settings like aspect ratio,
                  autoplay, mute, and more in just a few seconds
                </p>
                <p className="mt-auto text-[#9e9e9e] text-[14px] whitespace-break-spaces">
                  Divhunt
                </p>
